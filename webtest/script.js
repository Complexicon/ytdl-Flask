...
var apiHost = "https://tonal-griffin-263211.appspot.com/never%20gonna%20give%20you%20up";
...
convertBtn.addEventListener('click', function () {
    if (searchBox.value.includes('youtube.com')) {
        jQuery.getJSON(apiHost + searchBox.value, (info) => setPlayerInfo(info));
    } else jQuery.getJSON(apiHost + encodeURIComponent(searchBox.value), (info) => setPlayerInfo(info[0]));
});
